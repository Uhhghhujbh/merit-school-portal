...
const LandingPage = () => {
  ...
  // 1. ROTATING BACKGROUNDS (5 Professional Images)
  const [currentBg, setCurrentBg] = useState(0);
  const backgrounds = [
    "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?q=80&w=2070&auto=format&fit=crop", // Lecture Hall
    "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=2070&auto=format&fit=crop", // Library/Study
    "https://images.unsplash.com/photo-1606761568499-6d2451b23c66?q=80&w=2074&auto=format&fit=crop", // Modern Architecture
    "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=2086&auto=format&fit=crop", // Students Discussing
    "https://images.unsplash.com/photo-1592280771800-bcf9de2cb729?q=80&w=2070&auto=format&fit=crop"  // Campus Greenery
  ];

  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentBg((prev) => (prev + 1) % backgrounds.length);
    }, 6000); // Slower, smoother rotation (6s)
      ...
      <div className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left w-full mt-16">
          <div className="md:w-3/4 lg:w-2/3">
            ...
            {/* Main Heading - FIXED BREAKING TEXT */}
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white mb-8 leading-[1.1] tracking-tight drop-shadow-lg animate-fade-in-up delay-100">
              Knowledge For <br/>
              {/* Using standard text color instead of clip-text to ensure visibility */}
